...
public class Lab6_3{
	public static void main(String[] args){
        Employee emp = new Employee("Disha", 27, "123-456-7890", "Goverdhan Circle", 5000000, "Software Developer");
        Manager manager = new Manager("Drashti", 25, "987-654-3210", "Aayushman", 8000000, "Web Developer");
